...
async function setupTestEnvironment() {
  ...
  try {
    ...
    log('   node tests/manual/config-test.js', 'info');
    log('   node tests/integration/auth-flow-test.js', 'info');
    log('   node tests/integration/api-test-suite.js', 'info');
    log('   open tests/manual/socket-test.html', 'info');
